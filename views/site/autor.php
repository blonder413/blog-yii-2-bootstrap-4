...
if (isset($_GET['page'])) {
    $this->title = "Artículos de $user->name | Blonder413 - Página " . $_GET['page'];
} else {
    $this->title = "Artículos de $user->name";
}
...
<h1 class="text-center"><i class="fas fa-user"></i> <?= $user->name; ?></h1>
    ...
    <article class="blog-post">
        ...
        <p class="blog-post-meta">
            <?= $formatter->asDatetime($value->fecha_crea); ?> por 
            <?= Html::a(
